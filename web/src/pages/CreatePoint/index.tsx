...
const CreatePoint = () => {
    ...
    const [items, setItems] = useState<Items[]>([]) //array ou obj precisa ser informado o tipo
    ...
    const [initialPosition, setInitialPosition] = useState<[number, number]>([-27.6, -48.55])
    const [selectedPosition, setSelectedPosition] = useState<[number, number]>([-27.6, -48.55])
    ...
    function hancleSelectItem(id : number){
                ...
                <fieldset>
                    ...
                    <ul className="items-grid">
                        {items.map(item => 
                            <li 
                                key={item.id}
                                onClick={() => hancleSelectItem(item.id)}
